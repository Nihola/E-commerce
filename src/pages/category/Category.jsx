                ...
                <div className="flex flex-wrap justify-around gap-3 md:justify-center gap-5">
                  <NavLink to="/category/1">
                    <div className="relative rounded-lg overflow-hidden shadow-md ">
                      <img
                        className="sm:h-[20vh] md:h-[22vh] lg:h-[25vh]"
                        src={img1}
                        alt=""
                      />{" "}
                      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-green-600 to-transparent pt-20 p-3 text-white text-sm font-semibold hover:from-red-400">
                        Молоко, сыр, яйцо
                      </div>
                    </div>
                  </NavLink>
