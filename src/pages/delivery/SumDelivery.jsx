  ...
  return (
    <section className=' w-[300px]'>
      <div className='flex items-center gap-4 py-8'>
        <div onClick={() => setIsOn(!isOn)} className={`w-14 h-8 flex items-center bg-gray-300 rounded-full p-1 cursor-pointer ${isOn ? 'bg-green-500' : ''}`}><div className={`bg-white w-6 h-6 rounded-full shadow-md transform ${isOn ? 'translate-x-6' : ''}`}/>
        </div>
